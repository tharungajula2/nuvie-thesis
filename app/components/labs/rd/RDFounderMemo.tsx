...
export const RDFounderMemo: React.FC = () => {
    return (
        <section className="py-32 px-6">
            <div className="max-w-4xl mx-auto bg-graphite/10 border border-white/5 rounded-[40px] p-12 md:p-20 relative overflow-hidden backdrop-blur-3xl transition-all duration-700 hover:border-fuchsia-500/30">
