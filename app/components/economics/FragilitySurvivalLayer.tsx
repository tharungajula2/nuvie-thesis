...
export const FragilitySurvivalLayer: React.FC = () => {
    return (
        <section className="py-24 px-6 max-w-5xl mx-auto mb-20">
            <div className="bg-gradient-to-br from-[#1a1412] to-background border border-red-900/30 rounded-3xl p-10 md:p-16 relative overflow-hidden">
                <div className="absolute top-0 right-0 p-8 opacity-10">
                    <svg width="200" height="200" viewBox="0 0 24 24" fill="var(--color-red-500)">
                        <path d="M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z"/>
                    </svg>
                </div>

                <div className="relative z-10">
                    <span className="text-[10px] uppercase tracking-[0.4em] font-bold text-red-500/80 inline-block mb-6">OS Directives</span>
                    <h3 className="text-3xl md:text-5xl font-serif text-foreground mb-12">Operator Memo: Fragility</h3>

                    <div className="space-y-12">
                        {/* Directive 1 */}
                        <div>
                            <h4 className="text-xl font-serif text-red-400 mb-3">1. The RTD Delivery Paradox</h4>
                        ...
                        {/* Directive 2 */}
                        <div>
                            <h4 className="text-xl font-serif text-red-400 mb-3">2. The Margin Squeeze of Quick Commerce</h4>
                            <p className="text-foreground/70 leading-relaxed font-light">
                        ...
                        {/* Directive 3 */}
                        <div>
                            <h4 className="text-xl font-serif text-red-400 mb-3">3. Pack Architecture Defines Survival</h4>
                            <p className="text-foreground/70 leading-relaxed font-light">
                    ...
                    <div className="mt-16 pt-8 border-t border-red-900/30 flex items-center justify-between">
                        <div className="text-[10px] uppercase tracking-widest text-foreground/40 font-bold flex items-center">System Status: <span className="text-red-500 ml-3 flex items-center gap-2"><span className="w-2 h-2 bg-red-500 rounded-full animate-pulse" /> Margin Stress Detected</span></div>
                    </div>
                </div>
            </div>
        </section>
