...
export const QuickCommerceThesis: React.FC = () => {
    return (
        <section className="py-32 px-6 max-w-5xl mx-auto">
            <div className="relative border border-amber-500/20 bg-[#161205] rounded-[2.5rem] p-10 md:p-20 overflow-hidden group">
                {/* Tension Glows */}
                ...
                <div className="relative z-10 flex flex-col items-start">
                    <span className="text-[10px] uppercase tracking-[0.4em] font-bold text-amber-500/80 mb-6 flex items-center gap-3">
                        <span className="w-2 h-2 rounded-full bg-amber-500 animate-pulse" /> Dark Store Logic
                    </span>

                    <h3 className="text-4xl md:text-5xl font-serif text-amber-100 mb-8 leading-tight">
                        Quick Commerce is a <span className="italic text-amber-500">search engine</span>, not a grocery store.
                    </h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full border-t border-amber-900/40 pt-12">
                        <div>
                            <h5 className="font-serif text-lg text-amber-400 mb-2">The Visibility Trap</h5>
                            <p className="text-sm font-light text-amber-100/50 leading-relaxed">
                        ...
                        <div>
                            <h5 className="font-serif text-lg text-amber-400 mb-2">The Margin Bleed</h5>
                            <p className="text-sm font-light text-amber-100/50 leading-relaxed">
